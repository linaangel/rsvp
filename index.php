        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-xs-12 col-md-6 ">
                    <a href="new.php"><img class="img-responsive center-block" src="../app/img/create.png" height="300px" alt="RSVP Logo"></a>
                </div>
                <div class="col-xs-12 col-md-6">
                    <a href="categories.php"><img class="img-responsive center-block" src="../app/img/open.png" height="300px" alt="RSVP Logo"></a>
                </div>
            </div>
        </div>
        <br>
