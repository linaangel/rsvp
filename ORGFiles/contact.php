                ...
                <div class="col-md-6 col-md-offset-3" align="center">
                    ...
                    <form>
                      <div class="form-group inner-addon left-addon">
                        <i class="glyphicon glyphicon-user"></i><input type="text" class="form-control input-rsvp" id="contactname" placeholder="Name" required>
                      </div>
                      <div class="form-group inner-addon left-addon">
                        <i class="glyphicon glyphicon-envelope"></i><input type="email" class="form-control input-rsvp" id="contactemail" placeholder="Preferred Email">
                      </div>
                      <div class="form-group inner-addon left-addon">
                        <i class="glyphicon glyphicon-pencil"></i><textarea class="form-control input-rsvp " rows="3" placeholder="Support, Comments, Questions?" required></textarea>
                      </div>
