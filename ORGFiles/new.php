                ...
                <div class="col-xs-12 col-md-6">
                    <form>
                      <div class="form-group inner-addon left-addon">
                        <i class="glyphicon glyphicon-user"></i><input type="text" class="form-control input-rsvp" id="name" placeholder="Event Name" required>
                      </div>
                      ...
                      <br>
                      <div class="form-group inner-addon left-addon">
                        <i class="glyphicon glyphicon-envelope"></i><input type="email" class="form-control input-rsvp" id="email" placeholder="Guest Emails separated by semicolon">
                      </div>
                      <div class="checkbox">
                        <label>
                          <input type="checkbox"> Ask Food Preference / Allergies
                        </label>
                      </div>
