                ...
                <div class="col-xs-12 col-md-6">
                    ...
                    <form>
                      <div class="form-group inner-addon left-addon">
                        <i class="glyphicon glyphicon-cutlery"></i><input type="text" class="form-control input-rsvp" id="category" placeholder="Category Name" required>
                      </div>
                      <div class="input-group" name="seats">
